...
{ 
	...
	while(1) {
		...
		*/
		...
		/* ora tocca a me depositare */
		StatoDistributore=APPOGGIANDOBICCHIERE; /* impedisco ad altri di appoggiare */
...
{ 
	...
	/* ATTENZIONE - COMPLETARE LA TERMINAZIONE DEL main */	
	pthread_exit(NULL);
